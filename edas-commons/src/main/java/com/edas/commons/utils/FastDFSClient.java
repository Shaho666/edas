package com.edas.commons.utils;
...
public class FastDFSClient {
	...
	/*
	 * //将字节流写到磁盘生成文件 private void saveFile(byte[] b,BufferedOutputStream output) {
	 * 
	 * // try{ if(b != null){ output.write(b); } }catch (Exception e){} //用户可能取消了下载
	 * finally { if (output != null) try { output.close(); // storageServer.close();
	 * // trackerServer.close(); } catch (IOException e) { e.printStackTrace(); } }
	 * 
	 * }
	 */
