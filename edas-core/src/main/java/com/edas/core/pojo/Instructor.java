...
public class Instructor {
	...
	public Instructor(TbInstructor instructor, String place) {
		
		this.instructorId = instructor.getInstructorId();
		
		this.instructorName = instructor.getInstructorName();
				
		this.instructorPlace = place;
		
		this.instructorTel = instructor.getInstructorTel();
		
		this.instructorEmail = instructor.getInstructorEmail();
		
		this.instructorAge = instructor.getInstructorAge();
